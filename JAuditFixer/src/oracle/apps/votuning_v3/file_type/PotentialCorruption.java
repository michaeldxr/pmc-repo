...
public class PotentialCorruption
{
    ...
    public PotentialCorruption(String firstJarName, String firstFileName, String secondJarName, String secondFileName, String type,  String description)
    {
    ...
    public static void register(String firstJarName, String firstFileName, String secondJarName, String secondFileName, String type, String description)
    {
       PotentialCorruption pc = new PotentialCorruption(firstJarName, firstFileName, secondJarName, secondFileName, type, description);
       list.add(pc);
   }
    ...
    public static void dumpSheet(Workbook myBook)
    {
        ...
        dupSheet.setColumnWidth(5, 25);
        dupSheet.addCell(new Cell(new CellLocation("F1"),
        ...
        while(iter.hasNext())
        {
            ...
            cellNumber = "E" + dupRow;
            dupSheet.addCell(new Cell(new CellLocation(cellNumber), new CellValue( pc.m_sType )));
