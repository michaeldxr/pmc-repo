...
public class ComboboxLovContentDeliveryFixer {
    ...
    public static void main(String[] args) throws Exception{
        ...
        if(args.length<2 || args[1]==null || args[1].equals("")) {
            ...
            System.out.println("Usage: comboboxLovContentDeliveryFinder.sh <path to csv containing violations>");
            System.exit(1);
        }
        ...
        ComboboxLovContentDeliveryFixer fixer = new ComboboxLovContentDeliveryFixer();
