    ...
    public static void processXcfgFile(ZipFile zf, ZipEntry ze)
    {
        try
        {
            ...
            if (nl1 == null || nl1.getLength() == 0)
            {
                ...
                PotentialCorruption.register("", "", theJarName, theXcfgName, "No AppModuleConfigs", "No AppModuleConfigs");
                return;
            }
            ...
            for (int i = 0; i < nl1.getLength(); i++)
            {
                ...
                if(nJboProject == null)
                {
                    ...
                    PotentialCorruption.register("", "", theJarName, theXcfgName, type, description);
                    continue;
                }
                ...
                if(tmp != null)
                {
                    ...
                    PotentialCorruption.register(tmp.sJarName, tmp.sXcfg, theJarName, theXcfgName, type, description);
