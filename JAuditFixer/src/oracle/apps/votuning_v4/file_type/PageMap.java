...
public class PageMap
{
    ...
    {            
        ...
        String theCpxName = null;
        try
        {
            theJarName = zf.getName();
            theCpxName = ze.getName();
            ...
            else if(nl1.getLength() > 1)
            {
                ...
                PotentialCorruption.register(theJarName, theCpxName, "", "", "Multiple PageMap found", "Too many page maps found in this file.");
                return;
            }
        ...
        {
            System.out.println("ERROR: Could not parse the pagemap: " + theCpxName);
