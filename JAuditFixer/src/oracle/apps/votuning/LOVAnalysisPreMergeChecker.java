...
public class LOVAnalysisPreMergeChecker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(args.length > 2){
            ...
            int releaseNumber=0;
            try{              
                releaseNumber = Integer.parseInt(release);
            }catch(NumberFormatException e){
               e.printStackTrace();
               releaseNumber=0;
            }
                
            if (releaseNumber >= 9) //Only run this check prior to release 9
                return;    
        }
        ...
        RunLOVAnalysis.writeToSpreadsheet(RunLOVAnalysis.onlyreqiured_analysisRecords, "Results");
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (!VoTuningDBWrapperLRG.insertInDB(parts[20]))
                continue;
