    ...
    public static void processCPXFile(ZipFile zf, ZipEntry ze)
    {
        try
        {
            ...
            else if(nl1.getLength() > 1)
            {
                ...
                PotentialCorruption.register(theJarName, theCpxName, "", "", "More than one pageDefinitionUsages sections found");
                return;
            }
            ...
            for(int i = 0; i < nl2.getLength(); i++)
            {
                ...
                else
                {
                    ...
                    PotentialCorruption.register(pdu.jar, pdu.id, theJarName, theCpxName, desc);
//                    System.out.println("******************************************************");
//                    System.out.println("CORRUPTION:  Duplicate Page Def Usages found");
//                    System.out.println(newPdu);
