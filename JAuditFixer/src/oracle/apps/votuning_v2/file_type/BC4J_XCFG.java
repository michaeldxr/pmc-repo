...
public class BC4J_XCFG
{
    public String sJarName;
    public String sXcfg;
    public String sName;
    public String sAppName;
    public String sJboProject;
    ...
    public static void processXcfgFile(ZipFile zf, ZipEntry ze)
    {
        try
        {
            ...
            {
                PotentialCorruption.register("", "", theJarName, theXcfgName, "No AppModuleConfigs");
                return;
            }
            ...
            for (int i = 0; i < nl1.getLength(); i++)
            {
                ...
                if(nJboProject == null)
                {
                    ...
                    PotentialCorruption.register("", "", theJarName, theXcfgName, description);
                    continue;
                }
                ...
                if(tmp != null)
                {
                    ...
                    PotentialCorruption.register(tmp.sJarName, tmp.sXcfg, theJarName, theXcfgName, description);
