...
public class RunLOVAnalysis implements Serializable
{
    ...
    transient private static Workbook m_myBook;
    transient static Worksheet m_analysisSheet;
    
    transient static HashSet<String> exemptions = new HashSet<String>();
    /**
    ...
    public static void main(String[] args) {
       ...
       if (args.length < 1  || isEmpty(args[0])) {
            System.out.println("Usage:  reviewTableFetchSizes.sh <path to your code in an open ade view>");
            System.exit(1);
        }
        ...
        lovAnalyzer.generateExemptionList();
        UiFileHelper.bDebug = bDebug;

        try {
            csvWriter = new BufferedWriter(new FileWriter("FetchSizes_scan_new.csv", append));
...
//            if(lovAnalyzer.hasSer())
//            {
//                RunLOVAnalysis saved = lovAnalyzer.readSer();
//                if(saved != null)
//                    lovAnalyzer = saved;
//            }
//            else
