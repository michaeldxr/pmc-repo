...
public class SQLDatePredicatePremerge {
    ...
    public static void main(String[] args) throws Exception{
        ...
        for(int i = 0; i < files.length; i++) {
            ...
            String fileofInterest = scanner.getFileOfInterest(filePath);
            if(fileofInterest.equals("VO"))               
                scanner.processVO(filePath);   
            else if(fileofInterest.equals("View"))               
                scanner.processView(filePath);   
            else if(fileofInterest.equals("PLSQL"))               
                scanner.processPkb(filePath);   
        }          
