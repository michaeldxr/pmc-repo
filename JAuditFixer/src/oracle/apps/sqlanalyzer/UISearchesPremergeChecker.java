...
public class UISearchesPremergeChecker {
    static ViewCriteriaUsedInUI vcScanner = new ViewCriteriaUsedInUI();
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(args.length > 2){
            ...
            try{              
                ...
                System.out.println("Could not determine release. Defaulting to 8...");
                releaseNum = 8;
            }
        }
        ...
        while((line = reader.readLine()) != null){
            ...
            if(parts.length < 20) 
                continue;         
            if(!parts[19].trim().startsWith("Simply") && releaseNum < 9)
                continue;
