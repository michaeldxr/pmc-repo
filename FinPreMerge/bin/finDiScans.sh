...
tstart="$(date +%s)"
outFile="$destdir"/"$txn"_diScan.out
resultFile="diResults.csv"
errCode=0
header="ADFDi Scans"
classToRun="oracle.apps.di.ADFDiStandardsChecker"
