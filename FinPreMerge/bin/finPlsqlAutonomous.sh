...
tstart="$(date +%s)"
outFile="$destdir"/"$txn"_plsqlAutonomous.out
resultFile="PlSqlAuto.csv"
errCode=0
header="PLSQL Autonomous Transaction Scan"
classToRun="oracle.apps.rup2scans.PlsqlAutonomousTxnScanner"
